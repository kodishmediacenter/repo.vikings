...
addon = xbmcaddon.Addon('plugin.video.fenix.flix')
...
def CHIndex():
    addon_log("CHIndex")
    fnix = "YUhSMGNEb3ZMMkZrWkc5dVptVnVhWGhsZG04dVlteHZaM053YjNRdVkyOXRMekl3TVRndk1Ea3ZabVZ1YVhndFpteHBlQzVvZEcxcw=="
