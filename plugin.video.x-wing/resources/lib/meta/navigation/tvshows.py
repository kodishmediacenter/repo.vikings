        ...
        for id in ids:
            ...
            if id == None or id == "None": pass
                ...
                try:
                    ...
                    xbmc.log("x-wing failed to add: {0}".format(id),xbmc.LOGNOTICE)
            ids_index += 1
