...
def music_add_artist_to_library(artist_name):
    ...
    pDialog.create('[COLOR lightseagreen]M[/COLOR]etalli[COLOR lightseagreen]Q[/COLOR] 4[COLOR lightseagreen]Q[/COLOR]ed', _("{0} {1} {2}").format(_("Adding"), artist_name, _("to library")))
