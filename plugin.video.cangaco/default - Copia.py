...
lista = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.cangaco/lista.xml").decode("utf-8"))
tube  = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.cangaco/tube.xml").decode("utf-8"))

play  = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.cangaco/play.m3u").decode("utf-8"))
mag  = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.cangaco/mag.xml").decode("utf-8"))
web  = os.path.join(xbmc.translatePath("special://home/addons/webinterface.kratos/index.html").decode("utf-8"))
playlistv = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.cangaco/playlistv.xml").decode("utf-8"))
vaddon = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.cangaco/vaddon.xml").decode("utf-8"))

m3u = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.cangaco/lista.m3u").decode("utf-8"))
...
def web_conect():
    		...
    		f.write('\n <b> ***** Download de Lista Personalizadas do Kratos ***** </b><BR><BR>')
                ...
                f.write('\n<BR><BR>')
                f.write('\n <a href="http://kratos-addons-kodish.16mb.com/repo/instal/plugin.video.cangaco/plugin.video.cangaco-3.0.0.zip">Extraia o arquivo coloque as Listas na raiz </a><BR>')
...
if base[0:4] == "aHR0":
    ...
    tp  = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.cangaco/resources/scripts/open.mp3").decode("utf-8"))
    xbmc.Player().play(tp)
