...
def getItems(items,fanart,dontLink=False):
        ...
        for item in items:
            ...
            try:
                ...
                elif len(item('BrazucaPlaytvbn')) >0:
                    for i in item('BrazucaPlaytvbn'):
                        if not i.string == None:
                            BrazucaPlaytvbn = 'http://www.thenightanimes.net/p//video-mp4.php?v='+i.string
                            url.append(BrazucaPlaytvbn)

                elif len(item('BrazucaPlaytvb')) >0:
                    for i in item('BrazucaPlaytvb'):
                        if not i.string == None:
                            BrazucaPlaytvb = 'http://www.branimes.com/video/video-play.mp4/?contentId='+i.string
