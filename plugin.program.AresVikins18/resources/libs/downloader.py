...
def download(url, dest, dp = None):
	if not dp:
		...
		dp.create(ADDONTITLE ,"Baixando o conteudo",' ', ' ')
	dp.update(0)
...
def _pbhook(numblocks, blocksize, filesize, dp, start_time):
	try: 
		...
		mbs = '[COLOR %s][B]Tamanho baixado:[/B] [COLOR %s]%.02f[/COLOR] MB of [COLOR %s]%.02f[/COLOR] MB[/COLOR]' % (COLOR2, COLOR1, currently_downloaded, COLOR1, total) 
