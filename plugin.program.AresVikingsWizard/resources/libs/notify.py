...
def firstRun():
	class MyWindow(xbmcgui.WindowXMLDialog):
		def __init__(self, *args, **kwargs):
			...
			self.msg   = "Atualmente nehuma build foi instalada utilizando o %s.\n\nPara instalar, pressione 'MENU DE BUILDS' e escolha uma de nossas versoes da %s ou 'IGNORAR' para nao aparecer mais essa mensagem.\n\nObrigado por usar o %s." % (ADDONTITLE,BUILDERNAME, ADDONTITLE)
