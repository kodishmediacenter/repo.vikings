...
AddonID = 'plugin.video.webplayer'
...
def rc_iframe(link):
        files = os.path.join(xbmc.translatePath("special://home/addons/webinterface.kratos/index.html").decode("utf-8"))
        arq = open(files, 'w')
        arq.write("<iframe name=""\"Player""\" =\"\" src=\""+link+"\" frameborder=\"0\" height=\"100%\" scrolling=\"no\" width=\"100%\" allowFullScreen> </iframe>")
        arq.close()
...
def playmultim3u(name, url, iconimage):
		...
		links = redeplayer.browser_player(os,url)
